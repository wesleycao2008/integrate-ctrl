  ...
  return (
    <section className="rounded-2xl border border-[#1e3a5f]/60 bg-[#0f172a]/60 p-4 shadow-lg shadow-black/40">
      <header className="mb-4 flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-3 text-xs">
          <div className="flex items-center gap-1">
            <span className="text-blue-200/60">模型健康度：</span>
            <span className="flex items-center gap-1 rounded-full bg-[#1e293b] px-2 py-0.5">
              <span
      ...
      <div className="grid gap-4 lg:grid-cols-[minmax(0,3fr)_minmax(0,2fr)]">
        <div className="h-52 rounded-xl border border-[#1e3a5f]/60 bg-[#0a0e1a]/60 p-2">
        ...
        <div className="flex flex-col gap-3">
          <div className="overflow-hidden rounded-xl border border-[#1e3a5f]/60 bg-[#0a0e1a]/60">
            <div className="border-b border-[#1e3a5f]/60 px-3 py-2 text-xs font-medium text-slate-100">
              逆变器平均补偿系数 γ
            </div>
