    ...
    <section className="h-full rounded-2xl border border-[#1e3a5f]/60 bg-[#0f172a]/60 p-4 shadow-lg shadow-black/40">
      ...
      <div className="space-y-4 text-xs">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          <div className="flex items-center gap-3 rounded-xl border border-[#1e3a5f]/60 bg-[#0a0e1a]/60 p-3">
            <div className="relative h-16 w-16">
              <div className="absolute inset-0 rounded-full border border-[#1e3a5f]/60 bg-[#0f172a]" />
              <div
                className="absolute inset-1 rounded-full"
                style={{
                  backgroundImage: `conic-gradient(#22c55e ${
                    successRate * 3.6
                  }deg, #1e3a5f ${successRate * 3.6}deg)`,
                }}
              />
              <div className="absolute inset-3 flex items-center justify-center rounded-full bg-[#0a0e1a]">
            ...
            <div>
              <p className="text-blue-200/60">下发成功率</p>
          ...
          <div className="flex items-center gap-3 rounded-xl border border-[#1e3a5f]/60 bg-[#0a0e1a]/60 p-3">
            <div className="relative h-16 w-16">
              <div className="absolute inset-0 rounded-full border border-[#1e3a5f]/60 bg-[#0f172a]" />
              <div className="absolute inset-2 flex items-center justify-center rounded-full bg-[#0a0e1a]">
            ...
            <div>
              <p className="text-blue-200/60">平均通信延迟</p>
              <p className="text-xs text-blue-100/90">
        ...
        {/* 时间轴甘特图 */}
        <div className="rounded-xl border border-[#1e3a5f]/60 bg-[#0a0e1a]/60 p-3">
            ...
            {timeline.map((item) => {
              ...
              return (
                <div key={item.id} className="flex items-center gap-2">
                  <div className="w-16 shrink-0 font-mono text-[11px] text-blue-100/90">
                    {item.id}
                  </div>
                  <div className="relative h-3 flex-1 rounded-full bg-[#1e293b]">
                    <div
                  ...
                  <div className="w-14 shrink-0 text-right text-[11px] text-blue-200/80">
                    {item.status === 'timeout'
                      ? '超时'
        ...
        {/* 异常列表 */}
        <div className="rounded-xl border border-[#1e3a5f]/60 bg-[#0a0e1a]/60">
          <div className="flex items-center justify-between border-b border-[#1e3a5f]/60 px-3 py-2 text-xs">
          ...
          <div className="max-h-40 overflow-auto text-xs">
            <table className="min-w-full border-separate border-spacing-0">
              <thead>
                <tr>
                  <th className="border-b border-[#1e3a5f]/60 px-2 py-1 text-left text-[11px] font-medium text-blue-200/80">
                    逆变器 ID
                  </th>
                  <th className="border-b border-[#1e3a5f]/60 px-2 py-1 text-left text-[11px] font-medium text-blue-200/80">
                    原因
              ...
              <tbody>
                {exceptions.map((ex) => (
                  <tr key={ex.id} className="border-b border-[#1e3a5f]/30">
                    ...
                    <td className="px-2 py-1.5 text-[11px] text-blue-100/90">
