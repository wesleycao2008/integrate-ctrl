    ...
    <section className="h-full rounded-2xl border border-[#1e3a5f]/60 bg-[#0f172a]/60 p-4 shadow-lg shadow-black/40">
      <header className="mb-4 flex items-start justify-between gap-3">
        ...
        <div className="flex flex-col items-end gap-1 text-xs">
          <label className="flex items-center gap-2 text-blue-200/60">
            场景：
            <select
              className="rounded border border-[#1e3a5f]/40 bg-[#0f172a] px-2 py-1 text-[11px] text-slate-100"
              value={scenario}
          ...
          <div className="flex items-center gap-2 text-[11px]">
            <span className="text-blue-200/60">模式：</span>
            <button
              type="button"
            ...
            <div key={key} className="space-y-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="w-16 rounded border border-[#1e3a5f]/40 bg-[#0f172a] px-1 py-0.5 text-right text-[11px] text-slate-100"
                />
              </div>
            </div>
          )
      ...
      <div className="mt-3 flex items-center justify-between border-t border-[#1e3a5f]/60 pt-2 text-[11px]">
        <div className="text-blue-200/60">
          <span>当前生效场景：</span>
          <span className="ml-1 rounded-full bg-[#1e293b] px-2 py-0.5 text-slate-100">
            {scenario}
          </span>
        </div>
        <button
          ...
          className="rounded-full border border-cyan-500/60 bg-cyan-500/10 px-3 py-1 text-[11px] text-cyan-200 hover:bg-cyan-500/20"
        >
          场景模拟（FAHP 推荐权重）
        </button>
      </div>
          ...
          <div className="w-full max-w-md rounded-xl border border-[#1e3a5f]/60 bg-[#0f172a] p-4 text-xs shadow-2xl">
            ...
            <div className="mt-3 grid gap-3 md:grid-cols-2">
              <label className="space-y-1">
                <span className="text-blue-200/80">预测误差（0–1）</span>
                <input
                  type="number"
                  min={0}
                  max={1}
              ...
              <label className="space-y-1">
                <span className="text-blue-200/80">负荷率（0–1）</span>
                <input
                  type="number"
                  min={0}
                  max={1}
            ...
            <div className="mt-3 grid grid-cols-2 gap-2 rounded-lg border border-[#1e3a5f]/60 bg-[#0a0e1a]/80 p-2">
              <div className="text-[11px] text-blue-200/60">FAHP 推荐权重</div>
              <div className="text-right text-[11px] text-blue-200/60">
                （可一键应用）
              </div>
              {(
                [
                ...
                <div
                  key={key}
                  className="flex items-center justify-between text-[11px] text-blue-100/90"
                >
                  <span>{label}</span>
